param(
    ...
    [string]$BackupPath = "\\wsl.localhost\Ubuntu\root\kernel\lab\candidates\rg40xxv-panel-adopt-closeflow-v1\rg40xxv-panel-adopt-closeflow-v1-persistent-legacy-p8.img",
    [string]$LogPath = "$env:TEMP\rg40xxv-p8-panel-adopt-closeflow-v1-deploy.log",
    [string]$PreWriteBackupPath = "$env:TEMP\rg40xxv-p8-before-panel-adopt-closeflow-v1.img",
    ...
    [string]$ExpectedBackupSha256 = "3ad679a0023261559a4062213819388a989b9bbbc63b20277c344587becd006a"
)
...
Set-Content -LiteralPath $LogPath -Value "RG40XX-V p8 deploy panel-adopt-closeflow-v1"
