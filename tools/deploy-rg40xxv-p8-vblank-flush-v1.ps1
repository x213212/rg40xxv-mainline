param(
    ...
    [string]$BackupPath = "\\wsl.localhost\Ubuntu\root\kernel\lab\candidates\rg40xxv-de33-vblank-flush-v1\rg40xxv-de33-vblank-flush-v1-persistent-legacy-p8.img",
    [string]$LogPath = "$env:TEMP\rg40xxv-p8-vblank-flush-v1-deploy.log",
    [string]$PreWriteBackupPath = "$env:TEMP\rg40xxv-p8-before-vblank-flush-v1.img",
    ...
    [string]$ExpectedBackupSha256 = "26aeddf0aa205ca30b4fa621cc919cdf4b910edabd51cf3fa687fad0b87af136"
)
...
Set-Content -LiteralPath $LogPath -Value "RG40XX-V p8 deploy de33-vblank-flush-v1"
